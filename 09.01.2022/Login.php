		...
		<input type="checkbox" id="chk" aria-hidden="true">
			...
			<div class="signup">
				<form action="connect.php" method="post">
					<label for="chk" aria-hidden="true" class="signup_label">Sign up</label>
					<input class="input2" type="text" placeholder="User name" required="" name="username">
					<input class="input2" type="email" placeholder="Email" required="" name="email">
					<input class="input2" type="password" placeholder="Password" required="" name="password">
