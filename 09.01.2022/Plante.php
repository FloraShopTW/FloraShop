					...
					<select style="border: 1px solid #F7F7F0; font-family: 'Roboto', sans-serif; color: #696763;" onchange="fetch_select(value);">
						...
						<div class="panel panel-default">
								...
								<div id="buchete" class="panel-collapse collapse">
									...
									<ul>
											<li><a href="" onclick="fetch_select('buchet_trandafiri');">Trandafiri</a></li>
											<li><a href="" onclick="fetch_select('buchet_frezii');">Frezii</a></li>
											<li><a href="" onclick="fetch_select('buchet_crizanteme');">Crizanteme</a></li>
											<li><a href="" onclick="fetch_select('buchet_orhidee');">Orhidee</a></li>
											<li><a href="" onclick="fetch_select('buchet_garoafe');">Garoafe</a></li>
											<li><a href="" onclick="fetch_select('buchet_crini');">Crini</a></li>
											<li><a href="" onclick="fetch_select('buchet_irisi');">Irisi</a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								...
								<div id="ghivece" class="panel-collapse collapse">
									<div class="panel-body">
									<ul>
                                        <li><a href="">Decorative prin flori</a></li>
											<li><a href="">Bonsai</a></li>
											<li><a href="">Cactusi</a></li>
											<li><a href="">Citrice</a></li>
											<li><a href="">Decorative prin frunze</a></li>
