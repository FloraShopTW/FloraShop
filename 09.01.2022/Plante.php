				...
				<div class="col-sm-3">
					...
					<select style="border: 1px solid #F7F7F0; font-family: 'Roboto', sans-serif; color: #696763;" onchange="fetch_select(value);">
						...
						<div class="panel panel-default">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title" ><a onclick="fetch_select('primavara');" style="cursor:pointer"><img src="images/zambila.PNG" style="margin-right:15px;">Flori de primavara</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title" ><a onclick="fetch_select('vara');" style="cursor:pointer"><img src="images/floarea_soarelui.PNG" style="margin-right:15px;">Flori de vara</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title" ><a onclick="fetch_select('toamna');" style="cursor:pointer"><img src="images/brandusa.PNG" style="margin-right:15px;">Flori de toamna</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title" ><a onclick="fetch_select('iarna');" style="cursor:pointer"><img src="images/ghiocei.PNG" style="margin-right:15px;"> Flori de iarna</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title" ><a onclick="fetch_select('carnivore');" ><img src="images/plante_carnivore.PNG" style="margin-right:15px;"> Plante carnivore/insectivore</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title" ><a onclick="fetch_select('baby_plants');" style="cursor:pointer"><img src="images/baby_plants.PNG" style="margin-right:15px;"> Baby plants</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title" ><a onclick="fetch_select('birou');" style="cursor:pointer"><img src="images/plante_birou.PNG" style="margin-right:15px;"> Plante de birou</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title" ><a onclick="fetch_select('rare');" style="cursor:pointer"><img src="images/plante_rare.PNG" style="margin-right:15px;"> Plante rare</a></h4>
								</div>
							</div>
