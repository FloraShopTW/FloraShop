...
if ($option=="recomandate1") {
    ...
    $records = mysqli_query($con,"select * from plants where category='Buchete cu flori' and subcategory='Trandafiri'");
} elseif ($option=="buchet_frezii") {
    $records = mysqli_query($con,"select * from plants where category='Buchete cu flori' and subcategory='Frezii'");
} elseif ($option=="buchet_crizanteme") {
    $records = mysqli_query($con,"select * from plants where category='Buchete cu flori' and subcategory='Crizanteme'");
} elseif ($option=="buchet_orhidee") {
    $records = mysqli_query($con,"select * from plants where category='Buchete cu flori' and subcategory='Orhidee'");
} elseif ($option=="buchet_garoafe") {
    $records = mysqli_query($con,"select * from plants where category='Buchete cu flori' and subcategory='Garoafe'");
} elseif ($option=="buchet_crini") {
    $records = mysqli_query($con,"select * from plants where category='Buchete cu flori' and subcategory='Crini'");
} elseif ($option=="buchet_irisi") {
    $records = mysqli_query($con,"select * from plants where category='Buchete cu flori' and subcategory='Irisi'");
} elseif ($option=="ghiveci") {
    $records = mysqli_query($con,"select * from plants where category='Ghivece cu flori'");
} elseif ($option=="ghiveci_decorative_flori") {
    $records = mysqli_query($con,"select * from plants where category='Ghivece cu flori' and subcategory='Decorative prin flori'");
} elseif ($option=="ghiveci_bonsai") {
    $records = mysqli_query($con,"select * from plants where category='Ghivece cu flori' and subcategory='Bonsai'");
} elseif ($option=="ghiveci_cactusi") {
    $records = mysqli_query($con,"select * from plants where category='Ghivece cu flori' and subcategory='Cactusi'");
} elseif ($option=="ghiveci_citrice") {
    $records = mysqli_query($con,"select * from plants where category='Ghivece cu flori' and subcategory='Citrice'");
} elseif ($option=="ghiveci_decorative_frunze") {
    $records = mysqli_query($con,"select * from plants where category='Ghivece cu flori' and subcategory='Decorative prin frunze'");
