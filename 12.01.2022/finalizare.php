...
<script src="https://kit.fontawesome.com/2ab25fe11c.js" crossorigin="anonymous"></script>
  ...
  <title> Finalizarea Comenzii </title>
...
<div class="container">
  <div class="title">
      <h2>Finalizarea <span> Comenzii </span></h2>
  </div>
<div class="d-flex">
  <form action="" method="">
    <label>
      <span class="lname">Nume <span class="required">*</span></span>
      <input type="text" name="fname">
    </label>
    <label>
      <span class="fname">Prenume <span class="required">*</span></span>
      <input type="text" name="lname">
    </label>
    
    <label>
      <span>Tara <span class="required">*</span></span>
      <select name="selection">
        <option value="select">Selecteaza o tara...</option>
    ...
    <label>
      <span>Adresa <span class="required">*</span></span>
      <input type="text" name="houseadd" placeholder="Strada si numarul" required>
    </label>
    
    <label>
      <span>Oras <span class="required">*</span></span>
      <input type="text" name="city"> 
    </label>
    <label>
      <span>Judet <span class="required">*</span></span>
      <input type="text" name="city"> 
    </label>
    
    <label>
      <span>Numar de telefon <span class="required">*</span></span>
      <input type="tel" name="city"> 
    </label>
    <label>
      <span>Adresa de Email <span class="required">*</span></span>
  ...
  <div class="Yorder">
    ...
    <div>
      <input type="radio" name="dbt" value="cd"> Ramburs
    </div>
    
    <button type="button">Plaseaza comanda</button>
  </div><!-- Yorder -->
 </div>
</div>
<!-- footer section -->
